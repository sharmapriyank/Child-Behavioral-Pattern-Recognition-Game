<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="mcq_nondecodable_training1.aspx.cs" Inherits="mcq_nondecodable_training1" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" style="text-align: center;padding:10px" Width="709px">
        <br />
         MCQ Non-Decodable Training Question : 1
        <br />
        <br />
    ...
    function SetValue() {
        ...
        if (selectedValue == "") {
            ...
            if (selectedValue == answer) {
                location.replace("/mcq_nondecodable_training2.aspx?Iscorrect=1&Iscorrectcount=" + count);
            }
            else {
                if (count == 0) {
                    ...
                    location.replace("/mcq_nondecodable_training2.aspx?Iscorrect=0&Iscorrectcount=" + count);
                }
            }
        }
    }
