<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="letter_id_training2.aspx.cs" Inherits="letter_id_training2" %>
    ...
    function SetValue() {
        ...
        if (selectedValue == "") {
            ...
            if (selectedValue == answer) {
                document.getElementById('ctrlaudio').src = '/audio/sound_id/LID_T4.wav';
                setTimeout(function () {
                    location.replace("/letter_id.aspx");
                }, 5000
            );
            }
            else {
                if ("<%=Iscorrect%>" == "1" && "<%=Iscorrectcount%>" == "0" && count == 0) {
                    document.getElementById('ctrlaudio').src = '/audio/sound_id/LID_T5.wav';
                    count++;
                }
                else {
                    document.getElementById('ctrlaudio').src = '/audio/sound_id/LID_T6.wav';
                    setTimeout(function () {
                        location.replace("/letter_id.aspx");
                    }, 2000
                   );
