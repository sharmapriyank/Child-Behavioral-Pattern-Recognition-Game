<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="m_sentence_training2.aspx.cs" Inherits="m_sentence_training2" %>
    ...
    <div>
      ...
      <input id="hidValueSS" type="hidden" runat="server" />
        <asp:Label ID="ms_lb1" Font-Size="13px" runat="server" 
            Text="Sentence Scrambler Training Question: 2"></asp:Label>
        <br />
        <br />
...
<script type="text/javascript">
    ...
    function SetValue() {
        ...
        if (newOrder == answer) {
            document.getElementById('ctrlaudio').src = '/audio/sound_id/S2P_T4.wav';
            setTimeout(function () {
                location.replace("/m_sentences.aspx")
            ...
            if ("<%=Iscorrect%>" == "1" && "<%=Iscorrectcount%>" == "0" && count == 0) {
                document.getElementById('ctrlaudio').src = '/audio/sound_id/S2P_T5.wav';
                count++;
            }
            else {
                document.getElementById('ctrlaudio').src = '/audio/sound_id/S2P_T6.wav';
                setTimeout(function () {
                    location.replace("/m_sentences.aspx");
                }, 2000
               );
