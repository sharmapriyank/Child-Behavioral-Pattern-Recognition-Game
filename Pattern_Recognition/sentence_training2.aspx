<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="sentence_training2.aspx.cs" Inherits="sentence_training2" %>
...
<script type="text/javascript">
    ...
    function SetValue() {
        ...
        if (newOrder == answer) {
            document.getElementById('ctrlaudio').src = '/audio/sound_id/W2S_T4.wav';
            setTimeout(function () {
                location.replace("/sentence.aspx");
            }, 5000
        );
            ...
            if ("<%=Iscorrect%>" == "1" && "<%=Iscorrectcount%>" == "0" && count == 0) {
                document.getElementById('ctrlaudio').src = '/audio/sound_id/W2S_T5.wav';
                count++;
            }
            else {
                document.getElementById('ctrlaudio').src = '/audio/sound_id/W2S_T6.wav';
                setTimeout(function () {
                    location.replace("/sentence.aspx");
                }, 2000
               );
