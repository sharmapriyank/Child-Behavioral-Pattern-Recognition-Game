<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="mcq_nondecodable_training2.aspx.cs" Inherits="mcq_nondecodable_training2" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" style="text-align: center;padding:10px" Width="709px">
        <br />
         MCQ Non-Decodable Training Question : 2
        <br />
        <br />
    ...
    function SetValue() {
        ...
        if (selectedValue == "") {
            ...
            if (selectedValue == answer) {
                ...
                setTimeout(function () {
                    location.replace("/test_mcq_non-decodable.aspx");
                }, 5000
            );
            }
            else {
